...
- [x] WSLg での表示確認を記録する（QLT-012）— #14（記録は quality/gate-proofs.md 第 11 節）
...
- [x] FR-043 Google Fonts 30 書体を同梱し、OS の書体をやめる — #34
- [x] FR-046 背景色を設定できるようにし、保存形式を v4 へ — #35
- [x] 透明度を入れて、外した（ちらつきは窓の合成側だった）— #49 → #58
- [x] FR-047 枠なしウィンドウ・ホバークローム・設定モーダル — #36
- [x] SWG-006 文字のアンチエイリアス（付け忘れられない形に）— #41
- [x] FR-048 文言の日英切り替えと UI 書体の同梱 — #42
- [x] タスクバーのアイコンを製品のものにする — #46
- [x] 移動アイコンをやめる — #48
- [x] Windows のショートカットから起動できるようにする — #50
